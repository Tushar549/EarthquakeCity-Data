...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		*/
		...
		noFill();
		arc(50,160,15,15,0,180);
		rect(42,185,15,15);
		fill(255,255,0);
		arc(50,245,10,10,0,180);
		fill(0,0,255);
		arc(50,265,10,10,0,180);
		fill(255,0,0);
		arc(50,285,10,10,0,180);
		fill(0, 0, 0);
	...
	private boolean isLand(PointFeature earthquake) {
		...
		for (Marker m : countryMarkers) {
			if(isInCountry(earthquake,m))// TODO: Finish this method using the helper method isInCountry
				return true;
	...
	private void printQuakes() 
	{
		...
		for(Marker cm:countryMarkers) {
			...
			//	EarthquakeMarker qm=(EarthquakeMarker)am;
				
			  //if(qm.getProperty("country")!="" && qm.getProperty("country")==countryName) {
		       	if(qm instanceof LandQuakeMarker && qm.getProperty("country")==countryName) {	
				quakeCounter++;
				}
				else if(qm instanceof OceanQuakeMarker && flag==0)
					oceanQuakes++;
