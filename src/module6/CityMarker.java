...
public class CityMarker extends CommonMarker  {
	...
	/*
	 * PApplet papp=new PApplet(); PImage img= papp.loadImage("palmTrees.jpg",
	 * "jpg");
	 */
	DrawCityMarker dcm=new DrawCityMarker();
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		 ...
		 * pg.pushStyle();
		 * 
		 * // IMPLEMENT: drawing triangle for each city pg.fill(150, 30, 30);
		 * pg.triangle(x, y-TRI_SIZE, x-TRI_SIZE, y+TRI_SIZE, x+TRI_SIZE, y+TRI_SIZE);
		 * 
		 * // Restore previous drawing style pg.popStyle();
		 */
